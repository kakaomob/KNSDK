...
func getRealmFromNexus() -> [Target] {
    let targets: [Target]  = [
        .binaryTarget(name: sdkName,
                      url: "https://devrepo.kakaomobility.com/repository/kakao-mobility-ios-knsdk-release/1.10.9/KNSDK/KNSDK.xcframework.zip",
                      checksum: "4ea6a19887611c991c5830279fdb09fe5695e89714aab1cdc10335c4fda5facc"),
